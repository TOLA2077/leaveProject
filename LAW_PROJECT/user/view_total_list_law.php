                ...
                <div class="dropdown-content">
                    ...
                    <div class="navbar-header1">
                        ...
                        <div class="containera">
                            <div class="contenta">
                                <p style="color: #0970d1;">ផ្ទាំងបង្ហាញព៍ត័មានអំពីការសុំច្បាប់សរុប  </p>
                                                </header>
                                                ...
                                                <table class="table table-success table-striped" id="data-table">
                                                    <thead>
                                                        ...
                                                        <?php
                                                            ...
                                                            // Retrieve user's requests and their status from the database for the current user
                                                            $sql = "SELECT id, first_name, last_name, num_days, fromDate, toDate, becuse, status, status_date FROM form_project WHERE user_id = ?";
