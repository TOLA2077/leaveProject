                ...
                <div class="dropdown-content">
                    ...
                    <div class="navbar-header1">
                        ...
                        <div class="containera">
                            <div class="contenta">
                                <p style="color: #0970d1;">ផ្ទាំងបង្ហាញព៍ត័មានក្នុងខែនេះ </p>
                                                </header>
...
// Retrieve user's requests and their status from the database for the current user for this month
$sql = "SELECT id, first_name, last_name, num_days, fromDate, toDate, becuse, status, status_date FROM form_project WHERE user_id = ? AND YEAR(fromDate) = ? AND MONTH(fromDate) = ?";
...
$stmt->bind_param("sss", $current_user_id, $current_year, $current_month);
$stmt->execute();
...
if ($result->num_rows > 0) {
    ...
    echo "No records found for the current user this month.";
}
