...
if (isset($_GET['user_id'])) {
    ...
    $queryTotal = "SELECT COUNT(*) AS total_cases, SUM(num_days) AS total_days FROM form_project WHERE user_id = ?";
    ...
    $queryCases = "SELECT * FROM form_project WHERE user_id = ?";
    $stmtCases = $conn->prepare($queryCases);
    $stmtCases->bind_param("s", $user_id);
    $stmtCases->execute();
